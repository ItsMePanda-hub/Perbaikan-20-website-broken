/* ================================================================
   berita.js — Logika Halaman Warta Lingkungan DPKPLH Sawahlunto
...
(function () {
  ...
  // 2. Parse URL parameters (e.g. ?category=Perumahan or ?q=search)
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 space-y-4">
          <div class="flex items-center gap-3">
            <span class="inline-block px-3.5 py-1 rounded-full bg-[#C25E2C] text-white text-xs font-semibold uppercase tracking-wider">
          ...
          <div class="pt-3 flex items-center justify-between gap-4">
            ...
            <a href="berita-detail.html?id=${featured.id}" class="btn-pill-terracotta px-7 py-2.5 text-sm font-medium inline-block shadow-sm">
              Baca Warta Lengkap
            </a>
          </div>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="rounded-2xl overflow-hidden shadow-lg aspect-video lg:aspect-square">
            <img src="${featured.image || 'assets/hero-dpkplh.jpg'}" alt="${featured.title}" class="w-full h-full object-cover">
          </div>
        </div>
      ...
      return `
        <article class="journal-card">
          <div class="journal-card-image-wrap">
            <img src="${article.image || 'assets/hero-dpkplh.jpg'}" alt="${article.title}">
          ...
          <div class="p-6 sm:p-7 flex flex-col justify-between flex-1">
            <div>
              <span class="text-xs text-[#738A80] block mb-2">${article.date}</span>
            ...
            <div class="pt-6 border-t border-[#064E3B]/10 mt-6 flex items-center justify-between">
              <span class="text-xs text-[#738A80]">${article.readTime || '3 menit baca'}</span>
              <a href="berita-detail.html?id=${article.id}" class="btn-pill-viridian px-5 py-2 text-xs font-medium inline-block">
                Selengkapnya
              </a>
            </div>
          </div>
        ...
        <button 
          ...
          class="w-10 h-10 rounded-full font-medium text-sm transition ${
            isActive
              ...
              : 'bg-white hover:bg-[#F4F8F5] text-[#064E3B] border border-[#064E3B]/20'
          }"
        >
          ${i}
        </button>
